...
class HuaweiAdsAdRenderer(
...
) : MoPubAdRenderer<HuaweiAdsNativeAdvanced.HuaweiNativeAd> {
    ...
    override fun renderAdView(view: View, nativeAd: HuaweiAdsNativeAdvanced.HuaweiNativeAd) {
    ...
    private fun updateHuaweiNativeAdView(staticNativeAd: HuaweiAdsNativeAdvanced.HuaweiNativeAd,
        ...
        NativeImageHelper.loadImageView(staticNativeAd.iconImageUrl,
    ...
    override fun supports(nativeAd: BaseNativeAd): Boolean {
        return nativeAd is HuaweiAdsNativeAdvanced.HuaweiNativeAd
    }
        ...
        companion object {
            ...
            fun fromViewBinder(
                ...
                return try {
                    ...
                    val adChoicesIconViewId = extraViews?.get(VIEW_BINDER_KEY_AD_CHOICES_ICON_CONTAINER)

...
import com.mopub.mobileads.HuaweiAdsAdapterConfiguration
import com.mopub.mobileads.HuaweiCustomEventDataKeys
import java.util.*
import java.util.concurrent.atomic.AtomicBoolean

class HuaweiAdsNativeAdvanced : CustomEventNative() {
    private val KEY_EXTRA_AD_UNIT_ID = HuaweiCustomEventDataKeys.AD_UNIT_ID_KEY
    private val KEY_EXTRA_ORIENTATION_PREFERENCE = HuaweiCustomEventDataKeys.KEY_EXTRA_ORIENTATION_PREFERENCE
    private val KEY_EXTRA_AD_CHOICES_PLACEMENT = HuaweiCustomEventDataKeys.KEY_EXTRA_AD_CHOICES_PLACEMENT
    private val KEY_EXPERIMENTAL_EXTRA_SWAP_MARGINS = HuaweiCustomEventDataKeys.KEY_EXPERIMENTAL_EXTRA_SWAP_MARGINS
    private val KEY_CONTENT_URL = HuaweiCustomEventDataKeys.CONTENT_URL_KEY
    private val TAG_FOR_CHILD_DIRECTED_KEY = HuaweiCustomEventDataKeys.TAG_FOR_CHILD_DIRECTED_KEY
    private val TAG_FOR_UNDER_AGE_OF_CONSENT_KEY = HuaweiCustomEventDataKeys.TAG_FOR_UNDER_AGE_OF_CONSENT_KEY
    private val ADAPTER_NAME = HuaweiAdsNativeAdvanced::class.java.simpleName
                    ...
                    object : NativeImageHelper.ImageListener {
                        override fun onImagesCached() {
                            if (huaweiNativeAd != null) {
                                ...
                                MoPubLog.log(getAdNetworkId(), AdapterLogEvent.LOAD_SUCCESS, ADAPTER_NAME)
                            }
                        }

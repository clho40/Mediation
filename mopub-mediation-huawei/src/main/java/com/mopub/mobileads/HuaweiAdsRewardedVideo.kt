...
class HuaweiAdsRewardedVideo : BaseAd() {
    private val KEY_EXTRA_APPLICATION_ID = HuaweiCustomEventDataKeys.KEY_EXTRA_APPLICATION_ID
    ...
    private val ADAPTER_NAME: String = HuaweiAdsRewardedVideo::class.java.getSimpleName()

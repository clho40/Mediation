...
class HuaweiAdsInterstitial : BaseAd() {
    val AD_UNIT_ID_KEY = HuaweiCustomEventDataKeys.AD_UNIT_ID_KEY
    val CONTENT_URL_KEY = HuaweiCustomEventDataKeys.CONTENT_URL_KEY
    val TAG_FOR_CHILD_DIRECTED_KEY = HuaweiCustomEventDataKeys.TAG_FOR_CHILD_DIRECTED_KEY
    val TAG_FOR_UNDER_AGE_OF_CONSENT_KEY = HuaweiCustomEventDataKeys.TAG_FOR_UNDER_AGE_OF_CONSENT_KEY
    private val ADAPTER_NAME: String = HuaweiAdsInterstitial::class.java.getSimpleName()
